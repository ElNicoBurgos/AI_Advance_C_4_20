...
public:	
	...
	void Heal();
	//Eventos Heredados
	UFUNCTION(BlueprintImplementableEvent) void OnStartShoot();
	UFUNCTION(BlueprintImplementableEvent) void OnStopShoot();
	UFUNCTION(BlueprintImplementableEvent) void OnStartJump();
